...
import HelpModal from "../Modals/HelpModal/HelpModal.jsx";
  ...
  return (
    ...
    >
      ...
      <div className={styles.myBoardsSection}>
        <h2 className={styles.myBoardsTitle} style={{ color: theme.text }}>
          My boards
        </h2>
        ...
        <div className={styles.boardsList}>
          {boards.map((b) => {
            ...
            return (
              <div
                key={b._id}
                className={`${styles.sideBoards} ${
                  isActive ? styles.active : ""
                }`}
                style={{ color: theme.sideBoards }}
              >
                <BoardItem
                  board={b}
                  isActive={isActive}
        ...
        <div className={styles.blockContent}>
          ...
          <div className={styles.blockText}>
            <p
              ...
              style={{ color: theme.text }}
            >
              If you need help with <span className={styles.task}>TaskPro</span>
          ...
          <div className={styles.blockButtonContainer}>
            ...
            >
              <div
                ...
                style={{ color: theme.text, border: theme.helpIcon }}
              >
                ?
              </div>
              <span className={styles.helpText} style={{ color: theme.text }}>
                Need help?
              </span>
            </div>
          </div>
